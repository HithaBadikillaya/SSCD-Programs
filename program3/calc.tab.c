...
{
       2,    -8,    -7,     4,    14,    12,    19,     4,    -8,    11,
      -8,    -8,     4,     4,     4,     4,    19,    -8,    -6,    -6,
      -8,    -8
};
...
{
       9,    14,    15,     7,    16,     1,     2,     1,     8,    18,
      19,    20,    21,     3,    10,     3,    12,    13,    14,    15,
       0,    11,     0,    17,    12,    13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       3,     7,     8,    10,     7,     3,     4,     3,     4,    12,
      13,    14,    15,    11,     0,    11,     5,     6,     7,     8,
      -1,     9,    -1,    12,     5,     6,     7,     8
};
...
{
       0,     3,     4,    11,    14,    15,    16,    10,     4,    16,
       0,     9,     5,     6,     7,     8,    16,    12,    16,    16,
      16,    16
};
...
#line 1104 "calc.tab.c"
  ...
  case 3: /* stmt: ID '=' expr  */
#line 47 "calc.y"
                  { setval((yyvsp[-2].str),(yyvsp[0].num)); printf("Value=%d\n",(yyvsp[0].num)); }
...
#line 1152 "calc.tab.c"
  ...
  case 11: /* expr: ID  */
#line 58 "calc.y"
         { (yyval.num)=getval((yyvsp[0].str)); }
#line 1158 "calc.tab.c"
    break;
