...
#line 15 "eval.y"
                 { printf("Result=%d\n",yyvsp[-1]); exit(0); }
#line 1072 "eval.tab.c"
    break;

  case 3: /* expr: expr '+' expr  */
#line 18 "eval.y"
              { yyval=yyvsp[-2]+yyvsp[0]; }
#line 1078 "eval.tab.c"
    break;

  case 4: /* expr: expr '-' expr  */
#line 19 "eval.y"
                { yyval=yyvsp[-2]-yyvsp[0]; }
#line 1084 "eval.tab.c"
    break;

  case 5: /* expr: expr '*' expr  */
#line 20 "eval.y"
                { yyval=yyvsp[-2]*yyvsp[0]; }
#line 1090 "eval.tab.c"
    break;

  case 6: /* expr: expr '/' expr  */
#line 21 "eval.y"
                { yyval=yyvsp[-2]/yyvsp[0]; }
#line 1096 "eval.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 22 "eval.y"
               { yyval=yyvsp[-1]; }
#line 1102 "eval.tab.c"
    break;

  case 8: /* expr: NUM  */
#line 23 "eval.y"
      { yyval=yyvsp[0]; }
#line 1108 "eval.tab.c"
    break;


#line 1112 "eval.tab.c"
