...
#line 1078 "type.tab.c"
    break;

  case 3: /* stmt: INT ID '=' value ';'  */
#line 25 "type.y"
                     {
    if((yyvsp[-1].type)==1){
...
#line 1089 "type.tab.c"
    break;

  case 4: /* stmt: FLOAT ID '=' value ';'  */
#line 31 "type.y"
                         {
    if((yyvsp[-1].type)==0){
        printf("Type Mismatch\n");
...
#line 1100 "type.tab.c"
    break;

  case 5: /* value: NUM  */
#line 40 "type.y"
    { (yyval.type)=0; }
#line 1106 "type.tab.c"
    break;

  case 6: /* value: FNUM  */
#line 41 "type.y"
       { (yyval.type)=1; }
#line 1112 "type.tab.c"
    break;


#line 1116 "type.tab.c"
